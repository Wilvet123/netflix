...
const Footer = () => {
   ...
   return (
      <div>
         <div className='bg-black hidden justify-between text-xs
         px-9 items-center text-center py-5 text-gray fixed  w-full bottom-0 left-0  '>
         ...
         <div className='bg-black lg:block md:block  hidden w-full lg:pl-[480px]  md:pl-24 py-32 '>
            <div className='text-white flex gap-7 px-3 py-8'>
               <FaFacebookF size={25} />
               <BsInstagram size={25} />
               <AiFillYoutube size={25} />
            </div>
            <div className='flex flex-wrap text-gray  mb-11 items-center  gap-32 '>
               <div className='flex footer  flex-col gap-4'>
